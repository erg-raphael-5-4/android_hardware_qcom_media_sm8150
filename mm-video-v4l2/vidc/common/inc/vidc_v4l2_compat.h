...
// HDR static metadata controls (encoder)
// Display chromaticity primaries 3x2 matrix + whitepoint + display luminance + CLL/FLL
#ifndef V4L2_CID_MPEG_VIDC_VENC_RGB_PRIMARY_00
#define V4L2_CID_MPEG_VIDC_VENC_RGB_PRIMARY_00       (V4L2_CID_MPEG_MSM_VIDC_BASE + 130)
#define V4L2_CID_MPEG_VIDC_VENC_RGB_PRIMARY_01       (V4L2_CID_MPEG_MSM_VIDC_BASE + 131)
#define V4L2_CID_MPEG_VIDC_VENC_RGB_PRIMARY_10       (V4L2_CID_MPEG_MSM_VIDC_BASE + 132)
#define V4L2_CID_MPEG_VIDC_VENC_RGB_PRIMARY_11       (V4L2_CID_MPEG_MSM_VIDC_BASE + 133)
#define V4L2_CID_MPEG_VIDC_VENC_RGB_PRIMARY_20       (V4L2_CID_MPEG_MSM_VIDC_BASE + 134)
#define V4L2_CID_MPEG_VIDC_VENC_RGB_PRIMARY_21       (V4L2_CID_MPEG_MSM_VIDC_BASE + 135)
#define V4L2_CID_MPEG_VIDC_VENC_WHITEPOINT_X         (V4L2_CID_MPEG_MSM_VIDC_BASE + 136)
#define V4L2_CID_MPEG_VIDC_VENC_WHITEPOINT_Y         (V4L2_CID_MPEG_MSM_VIDC_BASE + 137)
#define V4L2_CID_MPEG_VIDC_VENC_MAX_DISP_LUM         (V4L2_CID_MPEG_MSM_VIDC_BASE + 138)
#define V4L2_CID_MPEG_VIDC_VENC_MIN_DISP_LUM         (V4L2_CID_MPEG_MSM_VIDC_BASE + 139)
#define V4L2_CID_MPEG_VIDC_VENC_MAX_CLL              (V4L2_CID_MPEG_MSM_VIDC_BASE + 140)
#define V4L2_CID_MPEG_VIDC_VENC_MAX_FLL              (V4L2_CID_MPEG_MSM_VIDC_BASE + 141)
#endif
