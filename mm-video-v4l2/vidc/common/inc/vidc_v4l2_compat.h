...
// SAR (sample aspect ratio) and blur dimension CIDs
#ifndef V4L2_CID_MPEG_VIDC_VENC_PARAM_SAR_WIDTH
#define V4L2_CID_MPEG_VIDC_VENC_PARAM_SAR_WIDTH      (V4L2_CID_MPEG_MSM_VIDC_BASE + 100)
#define V4L2_CID_MPEG_VIDC_VENC_PARAM_SAR_HEIGHT     (V4L2_CID_MPEG_MSM_VIDC_BASE + 101)
#endif
#ifndef V4L2_CID_MPEG_VIDC_VIDEO_BLUR_HEIGHT
#define V4L2_CID_MPEG_VIDC_VIDEO_BLUR_HEIGHT         (V4L2_CID_MPEG_MSM_VIDC_BASE + 102)
#endif

// IFRAME size type + enum values
#ifndef V4L2_CID_MPEG_VIDC_VIDEO_IFRAME_SIZE_TYPE
#define V4L2_CID_MPEG_VIDC_VIDEO_IFRAME_SIZE_TYPE    (V4L2_CID_MPEG_MSM_VIDC_BASE + 110)
#define V4L2_CID_MPEG_VIDC_VIDEO_IFRAME_SIZE_DEFAULT     0
#define V4L2_CID_MPEG_VIDC_VIDEO_IFRAME_SIZE_MEDIUM      1
#define V4L2_CID_MPEG_VIDC_VIDEO_IFRAME_SIZE_HUGE        2
#define V4L2_CID_MPEG_VIDC_VIDEO_IFRAME_SIZE_UNLIMITED   3
#endif

// Hier-P / Hier-B layer controls
#ifndef V4L2_CID_MPEG_VIDC_VIDEO_HYBRID_HIERP_MODE
#define V4L2_CID_MPEG_VIDC_VIDEO_HYBRID_HIERP_MODE   (V4L2_CID_MPEG_MSM_VIDC_BASE + 120)
#endif
#ifndef V4L2_CID_MPEG_VIDC_VIDEO_HIER_P_NUM_LAYERS
#define V4L2_CID_MPEG_VIDC_VIDEO_HIER_P_NUM_LAYERS   (V4L2_CID_MPEG_MSM_VIDC_BASE + 121)
#endif
#ifndef V4L2_CID_MPEG_VIDC_VIDEO_HIER_B_NUM_LAYERS
#define V4L2_CID_MPEG_VIDC_VIDEO_HIER_B_NUM_LAYERS   (V4L2_CID_MPEG_MSM_VIDC_BASE + 122)
#endif
#ifndef V4L2_CID_MPEG_VIDC_VIDEO_MAX_HIERP_LAYERS
#define V4L2_CID_MPEG_VIDC_VIDEO_MAX_HIERP_LAYERS    (V4L2_CID_MPEG_MSM_VIDC_BASE + 123)
#endif
